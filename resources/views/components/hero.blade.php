        ...
        <div class="row gx-5 align-items-center">
            <div class="col-xxl-5">
                <div class="text-center text-xxl-start">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase" id="keyLine">Software Engineer &middot; proficient in &middot; Laravel Framework</div></div>
                    <div class="fs-3 fw-light text-muted" id="short_title">Transforming Ideas into Online Growth with Laravel</div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline" id="title">Transforming Ideas into Online Growth with Laravel</span></h1>
